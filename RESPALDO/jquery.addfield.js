$(document).ready(function() {
	...
	$("#costo1").val(servicio[$("#servicio1").val()][1]);
	function myFunction() {
...
$newClone.children("select").eq(0).attr("id",'servicio'+newID).attr("name",'servicio'+newID);
//Borro el valor del segundo campo input(este caso es el campo de cantidad)
$newClone.children("input").eq(0).attr("id",'costo'+newID).attr("name",'costo'+newID).val('');
